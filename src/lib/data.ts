...
export const rivers: River[] = [
  ...
  },
  {
    ...
    length_km: 156,
    length_miles: 97,
    description: 'The River Tweed forms part of the border between Scotland and England. World-renowned for its Atlantic salmon fishing and stunning Scottish Borders scenery.',
    origin: 'Tweedsmuir, Scottish Borders',
    mouth: 'North Sea at Berwick-upon-Tweed',
    wildlife: ['Atlantic Salmon', 'Sea Trout', 'Brown Trout', 'Otters', 'Ospreys', 'Grey Seals', 'Red Squirrels'],
    activities: ['Salmon Fishing', 'Fly Fishing', 'Walking', 'Cycling', 'Wildlife Watching', 'Historic Sites'],
    has_gold: false,
    swimming_safety: 'Cold water year-round. Swimming possible in calm pools during summer with caution.',
  ...
  },
  {
    ...
    length_km: 82,
    length_miles: 51,
    description: 'The River Exe flows through Devon from Exmoor to the English Channel. Features a beautiful estuary and supports diverse wildlife in a protected environment.',
    origin: 'Exmoor, Somerset',
    mouth: 'English Channel at Exmouth',
    wildlife: ['Salmon', 'Sea Trout', 'Otters', 'Kingfishers', 'Avocets', 'Wading Birds', 'Seals'],
    activities: ['Fishing', 'Kayaking', 'Bird Watching', 'Walking', 'Cycling', 'Beach Activities'],
    has_gold: false,
    swimming_safety: 'Generally safe in designated areas. Beautiful estuary swimming spots available.',
    fishing_season: 'Salmon: February-September; Sea Trout: April-September',
    latitude: 50.6,
    longitude: -3.4,
    featured: true,
    image_url: 'https://images.pexels.com/photos/1118877/pexels-photo-1118877.jpeg',
